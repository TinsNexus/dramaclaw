...
感谢你考虑为 DramaHub 贡献。无论是修 bug、补文档还是加功能，都欢迎。
...
b. 你贡献的代码可用于商业用途，包括但不限于 DramaHub 的云 / 托管业务运营。

> 这一条让 DramaHub 能在 source-available 许可下，把社区贡献也用于官方托管/商业版本——这是「同一套代码、社区与商业不分叉」得以成立的前提。提交贡献即视为接受，无需另外签署。
